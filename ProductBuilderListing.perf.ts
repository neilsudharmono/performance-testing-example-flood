...
export default () => {
    ...
    async function checkProductListingAppear(browser) {
        ...
        const reports = await browser.findElements(By.css('[data-testid=defaultDescription]'))
	...
	step('Check Product Builder Listing Loaded', async browser => {
        // visit product page
        await browser.visit(pageURLs.productBuilderSet)
